...
import cl.duoc.SistemaMarket.service.VentaService;
...
public class VentaController {
    ...
    //Actualizar venta 
    @PutMapping("/{id}")
    public ResponseEntity<VentaDTO> actualizarVenta(@PathVariable int id, @Valid @RequestBody VentaDTO dto){
    ...
    //buscar por id 
    @GetMapping("/{id}")
    public ResponseEntity<VentaDTO> findById(@PathVariable int id){
        return ResponseEntity
